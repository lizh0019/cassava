...
CFG = {
    ...
    'epochs': 10,
    'train_bs': [12, 6, 4][model_choice],
    'valid_bs': [12, 6, 4][model_choice],
    'T_0': 10,
    'lr': 2e-4, #1e-4,
    'min_lr': 1e-6,
    'weight_decay':1e-6,
...
fpn_dim = {'tf_efficientnet_b4_ns':[24,32,56,112,160,272,448], 'tf_efficientnet_b5_ap':[24,40,64,128,176,304,512], 'tf_efficientnet_b6_ap':[32,40,72,144,200,344,576]}
resolution = {'tf_efficientnet_b4_ns':380, 'tf_efficientnet_b5_ap':456, 'tf_efficientnet_b6_ap':528}
...
if __name__ == '__main__':
    ...
    for fold, (trn_idx, val_idx) in enumerate(folds):
        ...
        train_loader, val_loader = prepare_dataloader(train, trn_idx, val_idx, data_root='../input/cassava-leaf-disease-classification/train_images_seg_lizhen/')
